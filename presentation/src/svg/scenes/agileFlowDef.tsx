...
const TableSurface = (
  <g>
    <ellipse cx="600" cy="370" rx="540" ry="170" fill="#1E1E2E" opacity="0.55"/>
    <ellipse cx="600" cy="368" rx="520" ry="145" fill="#252538" opacity="0.65"/>
  ...
  <g>
    {cardData.map((n, i) => (
      <g key={i} transform={`translate(${n.x}, ${n.y}) rotate(${n.rotate})`}>
        <rect x="8" y="10" width="138" height="76" rx="12" fill="#11111D" opacity="0.38"/>
