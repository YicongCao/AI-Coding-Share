...
const Defs = (
  <defs>
    ...
    <clipPath id="clipS1"><rect x="0" y="0" width="504" height="288" rx="10"/></clipPath>
    <clipPath id="clipS2"><rect x="0" y="0" width="240" height="340" rx="10"/></clipPath>
    <clipPath id="clipS3"><rect x="0" y="0" width="286" height="340" rx="10"/></clipPath>
    <clipPath id="clipS4"><rect x="0" y="0" width="504" height="145" rx="10"/></clipPath>
  </defs>
);
...
const ScreenshotTL = (
  <g transform="translate(-10, 10) rotate(-6)">
    <rect x="0" y="0" width="504" height="288" rx="10" fill="#1E1E2E" stroke="#FFFFFF" strokeOpacity="0.08" strokeWidth="1"/>
    <g clipPath="url(#clipS1)">
      <image href="/screenshots/s1.png" x="0" y="0" width="504" height="288" preserveAspectRatio="xMidYMid meet" opacity="0.7"/>
    </g>
  </g>
);
...
const ScreenshotTR = (
  <g transform="translate(940, 10) rotate(4)">
    <rect x="0" y="0" width="240" height="340" rx="10" fill="#1E1E2E" stroke="#FFFFFF" strokeOpacity="0.08" strokeWidth="1"/>
    <g clipPath="url(#clipS2)">
      <image href="/screenshots/s2.png" x="0" y="0" width="240" height="340" preserveAspectRatio="xMidYMid meet" opacity="0.7"/>
    </g>
  </g>
);
...
const ScreenshotBL = (
  <g transform="translate(10, 320) rotate(5)">
    <rect x="0" y="0" width="286" height="340" rx="10" fill="#1E1E2E" stroke="#FFFFFF" strokeOpacity="0.08" strokeWidth="1"/>
    <g clipPath="url(#clipS3)">
      <image href="/screenshots/s3.png" x="0" y="0" width="286" height="340" preserveAspectRatio="xMidYMid meet" opacity="0.7"/>
    </g>
  </g>
);
...
const ScreenshotBR = (
  <g transform="translate(680, 510) rotate(-3)">
    <rect x="0" y="0" width="504" height="145" rx="10" fill="#1E1E2E" stroke="#FFFFFF" strokeOpacity="0.08" strokeWidth="1"/>
    <g clipPath="url(#clipS4)">
      <image href="/screenshots/s4.png" x="0" y="0" width="504" height="145" preserveAspectRatio="xMidYMid meet" opacity="0.7"/>
    </g>
  </g>
);
